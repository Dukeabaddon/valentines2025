    ...
    return(
        <Card>
            <div className='flex justify-center items-center h-full pb-20'>
                <img src="../src/assets/oia-uia.gif" alt="cat" className="absolute mx-auto top-64 sm:top-14 w-36" />
                <div className="flex flex-col sm:flex-row items-center gap-8"> 
                    <img src="../src/assets/heart.png" alt="Heart" className="w-[150px] sm:w-auto"/>
